"use strict";
(self["webpackChunkaressa_restaurant_apps"] = self["webpackChunkaressa_restaurant_apps"] || []).push([[332],{
...
var FavoriteRestaurantIdb = {
  ...
  searchRestaurants: function searchRestaurants(query) {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      var restaurants, foundRestaurants;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            foundRestaurants = restaurants.filter(function (restaurant) {
              var loweredCaseRestaurantName = (restaurant.name || '').toLowerCase();
              var isMatch = loweredCaseRestaurantName.includes(query.toLowerCase());
              return isMatch;
            });
            return _context5.abrupt("return", foundRestaurants);
          case 5:
          case "end":
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ restaurant_detail)
});
...
var LikeButtonPresenter = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _this._favoriteRestaurant = favorite_restaurant_idb/* default */.A;
            _context.next = 6;
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return favorite_restaurant_idb/* default */.A.getRestaurant(id);
          case 2:
  ...
  _renderLike: function _renderLike() {
    var _this3 = this;
    this._likeButtonContainer.innerHTML = (0,template_creator/* createLikeButtonTemplate */.OK)();
    ...
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return favorite_restaurant_idb/* default */.A.putRestaurant(_this3._restaurant);
          case 2:
  ...
  _renderLiked: function _renderLiked() {
    var _this4 = this;
    this._likeButtonContainer.innerHTML = (0,template_creator/* createLikedButtonTemplate */.s9)();
    var likeButton = document.querySelector('#likeButton');
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return favorite_restaurant_idb/* default */.A.deleteRestaurant(_this4._restaurant.id);
          case 2:
...
;// ./src/scripts/views/pages/restaurant-detail.js
...
function restaurant_detail_asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function restaurant_detail_asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { restaurant_detail_asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { restaurant_detail_asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
      ...
      return restaurant_detail_regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            errorContainer = document.querySelector('#mainError'); // Show loading skeleton
